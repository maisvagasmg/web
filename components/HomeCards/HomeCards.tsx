import { Button, Card, Flex, Hide, HStack, Icon, Show, SimpleGrid, Spacer, Text, Image } from '@chakra-ui/react';
import { Briefcase, CaretRight, ShieldChevron } from "@phosphor-icons/react";
